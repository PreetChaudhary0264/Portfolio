...
const Home = () => {
  return (
    <div className="text-gray-200 bg-neutral-900 space-y-24 overflow-hidden">
      ...
      {/* About Me Section */}
      <motion.section
        className="px-6 sm:px-10 py-10 max-w-6xl mx-auto"
        initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.8 }}
      >
        <h1 className="text-3xl sm:text-4xl font-bold text-blue-400 mb-6 text-center sm:text-left">
          About Me
        </h1>
        ...
        >
          <a
            href="/Resume.pdf"
            download
            className="px-6 py-3 bg-blue-600 rounded-xl hover:bg-blue-700 flex items-center justify-center gap-2 transition text-center"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-6 py-3 bg-yellow-500 rounded-xl hover:bg-yellow-600 flex items-center justify-center gap-2 transition text-center"
          >
      ...
      <motion.section
        className="px-6 sm:px-10 py-10 bg-gradient-to-b from-gray-900 to-black max-w-6xl mx-auto"
        initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.8 }}
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
          {[
            ...
            <motion.div
              key={i}
              className="bg-gray-800 p-6 sm:p-8 rounded-2xl shadow-lg text-center hover:scale-105 transition"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: i * 0.2 }}
            >
              <item.icon className={`text-4xl sm:text-5xl text-${item.color} mx-auto mb-4`} />
      ...
      <motion.section
        ...
        transition={{ duration: 0.8 }}
      >
        <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-blue-400 text-center sm:text-left">
